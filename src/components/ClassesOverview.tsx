      ...
      <div className="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {items.map((item, i) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="rounded-2xl bg-white/5 border border-white/10 p-6 hover:border-violet-400/40 hover:bg-white/[0.07] transition-colors"
          >
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500/20 to-pink-500/20 flex items-center justify-center mb-5">
